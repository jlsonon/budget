    ...
    <div className="min-h-screen flex flex-col p-6 bg-gray-50 dark:bg-gray-950">
      <div className="flex-1 mt-12 space-y-8">
        <div className="space-y-2">
          <h1 className="text-3xl font-extrabold text-gray-900 dark:text-gray-100">Set your starting balance</h1>
          <p className="text-gray-600 dark:text-gray-400">How much money do you currently have?</p>
        </div>

        <div className="bg-white dark:bg-gray-900 rounded-3xl p-6 shadow-sm border border-gray-100 dark:border-gray-800">
          <label className="block text-sm font-medium text-gray-500 mb-2">Main Wallet Balance</label>
