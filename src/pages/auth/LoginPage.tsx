    ...
    <div className="flex flex-col items-center">
      ...
      <div className="mt-6 w-full space-y-3">
        ...
        <button
          ...
          disabled={isLoading}
          className="w-full mochi-btn-secondary py-3 gap-3"
        >
        ...
        <div className="flex items-center gap-3 py-2">
          <div className="flex-1 h-px bg-mochi-border" />
          <span className="text-xs text-mochi-text-muted">or</span>
          <div className="flex-1 h-px bg-mochi-border" />
        </div>
        ...
        <form onSubmit={handleEmailLogin} className="w-full space-y-3">
          {error && (
            <motion.div
              ...
              className="p-3 rounded-lg bg-mochi-error/10 text-mochi-error text-xs text-center"
            >
              {error}
            </motion.div>
          )}
          ...
          <div>
            <label htmlFor="login-email" className="mochi-label">Email</label>
          ...
          <div>
            <label htmlFor="login-password" className="mochi-label">Password</label>
            <div className="relative">
              ...
              <input
                ...
                className="mochi-input pl-10 pr-10"
                placeholder="••••••••"
                required
              ...
              >
                {showPassword ? (
                  <EyeOff className="w-4 h-4 text-mochi-text-muted" />
                ) : (
                  <Eye className="w-4 h-4 text-mochi-text-muted" />
                )}
              </button>
            </div>
          </div>
          ...
          <button
            type="submit"
            disabled={isLoading}
            className="w-full mochi-btn-primary py-3"
          >
